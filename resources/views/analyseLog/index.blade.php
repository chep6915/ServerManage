...
{{--        <script type="text/javascript" src="{{ asset('/view/analyseLog/js/jquery-1.7.2.min.js') }}"></script>--}}
        <script type="text/javascript" src="{{ asset('/view/analyseLog/js/jquery.cookie.js') }}"></script>
{{--        <script type="text/javascript" src="{{ asset('/view/analyseLog/js/lhgcalendar.min.js') }}"></script>--}}
    </head>
    <body>
    <div class="header">
        <div class="hdlogo clearfix">
            <div class="wrap clearfix">
                ...
                <div class="hdlinks">
{{--                    <script language="javascript" src="{{ asset('/view/analyseLog/js/2.js') }}"></script>--}}
                </div>
            </div>
        </div>
    </div>
...
{{--                <script language="javascript" src="{{ asset('/view/analyseLog/js/18.js') }}"></script>--}}
            </ul>
        </div>
    </div>
    <div class="wrap">
        <script language="javascript" src="{{ asset('/view/analyseLog/js/3.js') }}"></script>
    </div>
    <div class="wrap">
        <div style="float:left; width:30%; height:auto;" id="left">
            ...
            <script language="javascript" src="{{ asset('/view/analyseLog/js/base64encodedecode.js') }}"></script>
            <script language="javascript" src="{{ asset('/view/analyseLog/js/file.js') }}"></script>
            <script language="javascript" src="{{ asset('/view/analyseLog/js/22.js') }}"></script>
...
{{--            <script language="javascript" src="{{ asset('/view/analyseLog/js/12.js') }}"></script>--}}
        </div>
    ...
    <div class="wrap">
        <script language="javascript" src="{{ asset('/view/analyseLog/js/4.js') }}"></script>
    </div>
    <!--页脚-->
    <div class="footer">
        <div class="w">
...
{{--                <script type="text/javascript" src="{{ asset('/view/analyseLog/js/5.js') }}"></script>--}}
            </div>
        </div>
    </div>
    <!--返回顶部-->
{{--    <script type="text/javascript" src="{{ asset('/view/analyseLog/js/totop.js') }}"></script>--}}
    <!--返回顶部 END-->
    <script language="javascript" src="{{ asset('/view/analyseLog/js/1.js') }}"></script>
    <script language="javascript" src="{{ asset('/view/analyseLog/js/15.js') }}"></script>
{{--    <script language="javascript" src="{{ asset('/view/analyseLog/js/20.js') }}"></script>--}}
{{--    <script language="javascript" src="{{ asset('/view/analyseLog/js/jq.js') }}"></script>--}}
{{--    <script language="javascript" src="{{ asset('/view/analyseLog/js/data.js') }}"></script>--}}
    <div id="fugaitishi"></div>
{{--    <script language="javascript" src="{{ asset('/view/analyseLog/js/fugaitishi.js') }}"></script>--}}
{{--    <script language="javascript" src="{{ asset('/view/analyseLog/js/tuiguang.js') }}"></script>--}}
    </body>
</html>
