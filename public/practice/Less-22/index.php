...
if(!isset($_COOKIE['uname']))
	...
	echo '<img src="/practice/images/Less-22.jpg" />';
	echo '</center>';
	...
	if(isset($_POST['uname']) && isset($_POST['passwd']))
		...
		$row1 = mysqli_fetch_array($result1);
			if($row1)
				...
				echo "<br><br>";
				echo '<img src="/practice/images/flag.jpg" />';
				echo "<br>";
				}
			else
				{
				...
				echo "</br>";			
				echo "</br>";
				echo '<img src="/practice/images/slap.jpg" />';
				echo "</font>";  
				}
			}
	...
	if(!isset($_POST['submit']))
		{
			...
			echo "<center>";
			echo "<br><br><br><b>";
			echo '<img src="/practice/images/Less-21.jpg" />';
			echo "<br><br><b>";
			...
			if (!$result)
  				{
  				die('Issue with your mysqlii: ' . mysqli_error($con));
  				}
			...
			if($row)
				...
				echo "<center>";
				echo '<br><br><br>';
				echo '<img src="/practice/images/slap1.jpg" />';
				echo "<br><br><b>";
				//echo '<img src="/practice/images/Less-20.jpg" />';
				}
			echo '<center>';
		...
		echo '</font></center></br>';
			...
			//echo '<img src="/practice/images/slap.jpg" /></center>';
